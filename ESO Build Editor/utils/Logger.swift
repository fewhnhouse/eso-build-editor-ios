...
class Logger {
    ...
    class func log(_ logEvent: LogEvent, _ object: Any, filename: String = #file, line: Int = #line, column: Int = #column, funcName: String = #function) {
        switch (logEvent) {
        case .debug:
            d(object, filename: filename, line: line, column: column, funcName: funcName)
            break
        case .info:
            i(object, filename: filename, line: line, column: column, funcName: funcName)
            break
        case .warning:
            w(object, filename: filename, line: line, column: column, funcName: funcName)
            break
        case .error:
            e(object, filename: filename, line: line, column: column, funcName: funcName)
            break
        case .verbose:
            v(object, filename: filename, line: line, column: column, funcName: funcName)
            break
        case .severe:
            d(object, filename: filename, line: line, column: column, funcName: funcName)
            break
